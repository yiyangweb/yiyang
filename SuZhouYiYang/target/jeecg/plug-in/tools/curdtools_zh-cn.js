							   ...
							   var str = "";
						    	...
						    	if(str.indexOf("undefined")==-1){
						    		...
						    		﻿	//update--begin--author:scott date:20171031 for:TASK #2385 online和代码生成器 一对多行popup多字段赋值问题解决-----------
						    			...
						    			$("input[name='"+inpu+"']").val(str).change();
						    		}else{
						    			$("input[name='"+inputfield[i1]+"']").val(str).change();
						    		}
						    	}else{
						    		if(inputs.length>1){
						    			...
						    			$("input[name='"+inpu+"']").val("").change();
						    		}else{
						    			$("input[name='"+inputfield[i1]+"']").val("").change();
						    		}
						    	}
					    	}
				    	}else{
				    		...
				    		if(inputfield.length>1){
						    	...
						    	if(str.indexOf("undefined")==-1){
						    		if(inputs.length>1){
						    			...
						    			$("input[name='"+inputfield+"']").val(str).change();
						    		}
						    	}else{
						    		if(inputs.length>1){
						    			...
						    			$("input[name='"+inputfield+"']").val("").change();
						    		}
						    	}
				    		}
				    	}
