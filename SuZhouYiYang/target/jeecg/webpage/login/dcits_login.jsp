            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    ...
                    <div class="position-relative">
								...
								<span class="block input-icon input-icon-right">
									...
									<i class="ace-icon fa fa-lock"></i>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <!--
                                            <span> | <a
                                                    href="http://demo.jeecg.org/mLoginController.do?login&from=singlemessage&isappinstalled=0"><i
                                                    class="ace-icon fa fa-location-arrow"></i><font
                                                    color='#428bca'>移动OA</font></a></span>
                                            <span> | <a href="http://yun.jeecg.org" target="_blank"><i
                                                    class="ace-icon fa fa-cube"></i><font
                                                    color='#428bca'>插件中心</font></a></span>
                                            -->
                        ...
                        <div class="center"><h4 class="blue" id="id-company-text">&copy; 苏州怡养</h4></div>
