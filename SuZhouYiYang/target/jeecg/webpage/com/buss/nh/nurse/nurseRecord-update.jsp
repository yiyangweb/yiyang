...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nurseRecordController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
					<input id="id" name="id" type="hidden" value="${nurseRecordPage.id }"/>
			<input id="bedId" name="bedId" type="hidden" value="${nurseRecordPage.bedId }"/>
			<input id="customerNo" name="customerNo" type="hidden" value="${nurseRecordPage.customerNo }"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="roomName" name="roomName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.roomName}'/>
						...
						<td class="value">
							<input id="bedName" name="bedName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"  value='${nurseRecordPage.bedName}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="customerName" name="customerName" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="checked"  value='${nurseRecordPage.customerName}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="recordDate" name="recordDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" value='<fmt:formatDate value='${nurseRecordPage.recordDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="bloodPressure" name="bloodPressure" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.bloodPressure}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="pulse" name="pulse" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.pulse}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="animalHeat" name="animalHeat" type="text" style="width: 150px" class="inputxt" 		datatype="d" ignore="checked"  value='${nurseRecordPage.animalHeat}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="breath" name="breath" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.breath}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="charger" name="charger" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.charger}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="handoverDes" name="handoverDes" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${nurseRecordPage.handoverDes}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									<table id="attachment_fileTable"></table>
										<table></table>
										<script type="text/javascript">
											var serverMsg="";
											$(function(){
  ...
  <script src = "webpage/com/buss/nh/nurse/nurseRecord.js"></script>		
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "nurseRecordController.do?getFiles&id=" +  cgFormId,
