...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" beforeSubmit="checkMoney()" action="feeBillController.do?doUpdate" >
					<input id="id" name="id" type="hidden" value="${feeBillPage.id }"/>
	  				...
	  				<input id="fbStatus" name="fbStatus" type="hidden" value="${feeBillPage.fbStatus }"/>
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.name}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"   onclick="popupClick(this,'customerNo,customerName','customer_base')"  value='${feeBillPage.customerName}'/>			    
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="totalFee" name="totalFee" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.totalFee}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="charger" name="charger" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.charger}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="dealDate" name="dealDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore"  value='<fmt:formatDate value='${feeBillPage.dealDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="auditor" name="auditor" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.auditor}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="auditorDate" name="auditorDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore"  value='<fmt:formatDate value='${feeBillPage.auditorDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="auditorDes" name="auditorDes" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.auditorDes}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="remarks" name="remarks" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feeBillPage.remarks}'/>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_customerFeeDes_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td align="left">
					  				<input name="customerFeeDesList[#index#].customerNo" name="customerFeeDesList[#index#].customerNo" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"    onclick="popupClick(this,'no,name','customerNo,customerName','customer_base')" value="${poVal.customerNo }" />
				  ...
				  <td align="left">
					      	<input name="customerFeeDesList[#index#].countDate" maxlength="32" class="Wdate" onClick="WdatePicker()" ignore="ignore"  type="text"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:120px;" />
				  ...
				  <td align="left">
					      	<input name="customerFeeDesList[#index#].chargeDate" maxlength="32" class="Wdate" onClick="WdatePicker()" ignore="ignore"  type="text"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:120px;" />
		...
		<tbody id="add_paymentList_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="paymentListList[#index#].payDate" maxlength="32" type="text" style="width:120px;" class="Wdate" onClick="WdatePicker()" ignore="ignore" />
					  <label class="Validform_label" style="display: none;">支付时间</label>
				  </td>
				  <td align="left">
					  		<input name="paymentListList[#index#].receiveDate" maxlength="32" type="text" style="width:120px;" class="Wdate" onClick="WdatePicker()" ignore="ignore" />
