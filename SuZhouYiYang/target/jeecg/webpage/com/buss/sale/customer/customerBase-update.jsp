...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerBaseController.do?doUpdate" >
					<input id="id" name="id" type="hidden" value="${customerBasePage.id }"/>
	  				<input id="customerStatus" name="customerStatus" type="hidden" value="${customerBasePage.customerStatus }"/>
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt" 		datatype="*1-32" ignore="checked"  value='${customerBasePage.name}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="idCardNo" name="idCardNo" type="text" style="width: 150px" class="inputxt" 		datatype="*18-18" ignore="checked"  value='${customerBasePage.idCardNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt" 		datatype="n" ignore="checked"  value='${customerBasePage.age}'/>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_customerCommonCharge_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  				<input name="customerCommonChargeList[#index#].chargeNo" name="customerCommonChargeList[#index#].chargeNo" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="checked"    onclick="popupClick(this,'no,name,description,mode,belongdeptcode','chargeNo,name,description,modeCode,belongDept','charge_type_not_one_pop')" value="${poVal.chargeNo }" />
