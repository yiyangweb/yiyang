...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="mmVisitorRecordController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*1-32" ignore="checked"   onclick="popupClick(this,'name,no,sex,age','customerName,customerNo,sexId,age','customer_base')"  value='${mmVisitorRecordPage.customerName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="customerNo" name="customerNo" type="text" style="width: 150px" class="inputxt" datatype="*" ignore="checked" value='${mmVisitorRecordPage.customerNo}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input name="sexId" type="hidden" value="${mmVisitorRecordPage.sex }" onchange="onSexChange(this)"/>
					<t:dictSelect id="sexId" field="sex" type="list"   typeGroupCode="c_sex"  defaultVal="${mmVisitorRecordPage.sex}" hasLabel="false"  datatype="*" title="性别"></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="age" name="age" type="text" style="width: 150px" class="inputxt" 		datatype="n" ignore="ignore"  value='${mmVisitorRecordPage.age}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="phoneNo" name="phoneNo" type="text" style="width: 150px" class="inputxt" 		datatype="m" ignore="checked"  value='${mmVisitorRecordPage.phoneNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="adress" name="adress" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.adress}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="introducer" name="introducer" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.introducer}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="intentionalGold" name="intentionalGold" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.intentionalGold}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="visitNum" name="visitNum" type="text" style="width: 150px" class="inputxt" 		datatype="n" ignore="ignore"  value='${mmVisitorRecordPage.visitNum}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="others" name="others" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.others}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="interests" name="interests" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.interests}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="specialRequirements" name="specialRequirements" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${mmVisitorRecordPage.specialRequirements}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="destClerk" name="destClerk" type="text" style="width: 150px" class="inputxt" 		datatype="*1-32" ignore="checked"  value='${mmVisitorRecordPage.destClerk}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="vsitDate" name="vsitDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" ignore="checked"  value='<fmt:formatDate value='${mmVisitorRecordPage.vsitDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
