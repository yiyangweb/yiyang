...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" beforeSubmit="checkValid()" action="customerContractController.do?doAdd" callback="jeecgFormFileCallBack@Override">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  onclick="popupClick(this,'id,name,no','customerId,customerName,customerNo','customer_base')"/>			 
		...
		<tr>
			...
			<td class="value">
					  <t:dictSelect field="belongTo" type="list"   typeGroupCode="cs_status" defaultVal="1" hasLabel="false"  title="所属" ></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <t:dictSelect field="contractTypeId" type="list"   typeGroupCode="ht_type"  defaultVal="1" datatype="*" hasLabel="false"  title="合同类型" ></t:dictSelect>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <t:dictSelect field="isInstalments" type="list"   typeGroupCode="dev_flag"  defaultVal="0" datatype="*" hasLabel="false"  title="是否分期" ></t:dictSelect>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="numOfPeriods" name="numOfPeriods" type="text" style="width: 150px" class="inputxt" 	value="0"	datatype="n" ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="paymentStatus" name="paymentStatus" type="text" style="width: 150px" class="inputxt"  value="0%" ignore="ignore" readonly="true" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="buildingName" name="buildingName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  onclick="popupClick(this,'building_id,building_name,room_id,room_name,bed_id,bed_name,','buildingId,buildingName,roomId,roomName,bedId,bedName','empty_room_info')"/>
				<span class="Validform_checktip"></span>
	...
	<tbody id="add_contractChargeList_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="contractChargeListList[#index#].name" name="contractChargeListList[#index#].name" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"  onclick="popupClick(this,'chargetypeid,name,description,mode,belongdeptcode','chargeTypeId,name,description,type,belongDept','charge_type_one_popup')"/>
