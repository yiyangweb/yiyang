 ...
 * @date 2018-06-30 12:05:55
 * @version V1.0   
 *
 */
@Entity
@Table(name = "customer_job", schema = "")
@SuppressWarnings("serial")
public class CustomerJobEntity implements java.io.Serializable {
	/**主键*/
	...
	/**起止时间*/
    @Excel(name="起止时间",width=15)
	private java.lang.String beginEndDate;
	/**单位*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  起止时间
	 */
	
	@Column(name ="BEGIN_END_DATE",nullable=true,length=36)
	public java.lang.String getBeginEndDate(){
		return this.beginEndDate;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  起止时间
	 */
	public void setBeginEndDate(java.lang.String beginEndDate){
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  单位性质
	 */
	
	@Column(name ="COMPANY_TYPE",nullable=true,length=36)
