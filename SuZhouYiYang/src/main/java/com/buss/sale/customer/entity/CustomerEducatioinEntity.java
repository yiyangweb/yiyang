 ...
 */
@Entity
@Table(name = "customer_educatioin", schema = "")
@SuppressWarnings("serial")
public class CustomerEducatioinEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="MAJOR",nullable=true,length=36)
	...
	@Column(name ="EDUCATION",nullable=true,length=36)
