 ...
 */
@Entity
@Table(name = "contract_nh_charge_list", schema = "")
@SuppressWarnings("serial")
public class ContractNhChargeListEntity implements java.io.Serializable {
	/**主键*/
	...
	/**收费名称*/
    @Excel(name="收费名称",width=15,dictTable ="charge_type_one_popup",dicCode ="name,description,type",dicText ="name,description,mode")
	...
	/**护理院合同id*/
	private java.lang.String contractNhId;
	/**收费类型ID*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  护理院合同id
	 */
	
	@Column(name ="CONTRACT_NH_ID",nullable=true,length=36)
	public java.lang.String getContractNhId(){
		return this.contractNhId;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  护理院合同id
	 */
	public void setContractNhId(java.lang.String contractNhId){
		this.contractNhId = contractNhId;
	}
