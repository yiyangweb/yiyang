 ...
 * @date 2018-07-08 20:59:44
 * @version V1.0   
 *
 */
@Entity
@Table(name = "customer_contract_sub", schema = "")
@SuppressWarnings("serial")
public class CustomerContractSubEntity implements java.io.Serializable {
	/**主键*/
