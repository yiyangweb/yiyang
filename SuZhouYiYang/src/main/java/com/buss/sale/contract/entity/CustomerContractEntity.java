 ...
 */
@Entity
@Table(name = "customer_contract", schema = "")
@SuppressWarnings("serial")
public class CustomerContractEntity implements java.io.Serializable {
	/**主键*/
	...
	/**客户名称*/
    @Excel(name="客户名称",width=15,dictTable ="customer_base",dicCode ="customerId,customerName,customerNo",dicText ="id,name,no")
	...
	/**合同类型*/
    @Excel(name="合同类型",width=15,dicCode="ht_type")
	private java.lang.String contractTypeId;
	/**是否分期*/
    @Excel(name="是否分期",width=15,dicCode="dev_flag")
	private java.lang.String isInstalments;
	/**分期期数*/
    @Excel(name="分期期数",width=15)
	...
	/**楼栋*/
    @Excel(name="楼栋",width=15,dictTable ="empty_room_info",dicCode ="buildingId,buildingName,roomId,roomName",dicText ="building_id,building_name,room_id,room_name")
	...
	@Column(name ="CONTRACT_TYPE_ID",nullable=true,length=32)
	...
	@Column(name ="IS_INSTALMENTS",nullable=true,length=32)
	...
	@Column(name ="NUM_OF_PERIODS",nullable=true,length=32)
