 ...
 */
@Entity
@Table(name = "customer_room_des", schema = "")
@SuppressWarnings("serial")
public class CustomerRoomDesEntity implements java.io.Serializable {
	/**主键*/
	...
	/**顾客姓名*/
    @Excel(name="顾客姓名",width=15,dictTable ="customer_base",dicCode ="customerId,customerName",dicText ="id,name")
	private java.lang.String customerName;
	/**亲属关系*/
    @Excel(name="亲属关系",width=15,dicCode="qs_type")
	...
	@Column(name ="IN_ID",nullable=true,length=36)
