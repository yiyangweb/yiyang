package com.buss.apt.leave.entity;
 ...
 */
@Entity
@Table(name = "customer_leave_nh", schema = "")
@SuppressWarnings("serial")
public class CustomerLeaveNhEntity implements java.io.Serializable {
	/**主键*/
	...
	/**房间*/
    @Excel(name="房间",width=15,dictTable ="stayin_info",dicCode ="stayinId,roomId,roomName,customerName,customerNo",dicText ="id, room_id,room_name,room_name,customer_name,customer_no")
	...
	/**流程状态*/
    @Excel(name="流程状态",width=15,dicCode="tz_status")
	...
	@Column(name ="STAYIN_ID",nullable=true,length=36)
