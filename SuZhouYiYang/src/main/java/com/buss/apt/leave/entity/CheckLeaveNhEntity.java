 ...
 */
@Entity
@Table(name = "check_leave_nh", schema = "")
@SuppressWarnings("serial")
public class CheckLeaveNhEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="TZ_ID",nullable=true,length=36)
	 ...
	 */
	public void setTzId(java.lang.String tzId){
		this.tzId = tzId;
	}
