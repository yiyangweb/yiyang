 ...
 */
@Entity
@Table(name = "customer_change_room", schema = "")
@SuppressWarnings("serial")
public class CustomerChangeRoomEntity implements java.io.Serializable {
	/**主键*/
	...
	/**换房编号*/
    @Excel(name="换房编号",width=15)
	private java.lang.String no;
	/**入住id*/
	private java.lang.String originId;
	/**顾客姓名*/
    @Excel(name="顾客姓名",width=15,dictTable ="stayin_info",dicCode ="originId,customerName,originRoomId,originRoom,originBuildingId,originBuildingName",dicText ="id,customer_name,room_id,room_name,building_id,building_name")
	private java.lang.String customerName;
	/**原房间id*/
	private java.lang.String originRoomId;
	/**原房间*/
    @Excel(name="原房间",width=15)
	private java.lang.String originRoom;
	/**原楼栋id*/
	private java.lang.String originBuildingId;
	/**原楼栋*/
    @Excel(name="原楼栋",width=15)
	private java.lang.String originBuildingName;
	/**交换房间id*/
	private java.lang.String newRoomId;
	/**交换房间*/
    @Excel(name="交换房间",width=15,dictTable ="empty_room_info",dicCode ="newRoomId,newRoomName,newBuildingId,newBuildingName",dicText ="room_id,room_name,building_id,building_name")
	private java.lang.String newRoomName;
	/**交换楼栋id*/
	private java.lang.String newBuildingId;
	/**交换楼栋*/
    @Excel(name="交换楼栋",width=15)
	private java.lang.String newBuildingName;
	/**换房状态*/
    @Excel(name="换房状态",width=15,dicCode="hf_status")
	private java.lang.String status;
	/**办理人*/
    @Excel(name="办理人",width=15)
	private java.lang.String inCharge;
	/**办理时间*/
    @Excel(name="办理时间",width=15,format = "yyyy-MM-dd")
	...
	@Column(name ="ORIGIN_ROOM_ID",nullable=true,length=36)
	...
	@Column(name ="ORIGIN_ROOM",nullable=true,length=36)
	...
	@Column(name ="ORIGIN_BUILDING_ID",nullable=true,length=36)
	...
	@Column(name ="ORIGIN_BUILDING_NAME",nullable=true,length=36)
	...
	@Column(name ="NEW_ROOM_ID",nullable=true,length=36)
	...
	@Column(name ="NEW_ROOM_NAME",nullable=true,length=36)
	...
	@Column(name ="NEW_BUILDING_ID",nullable=true,length=36)
	...
	@Column(name ="NEW_BUILDING_NAME",nullable=true,length=36)
	...
	@Column(name ="IN_CHARGE",nullable=true,length=36)
	...
	@Column(name ="AUDITOR",nullable=true,length=36)
	...
	@Column(name ="AUDIT_DES",nullable=true,length=100)
