...
@Service("baseBuildingAreaService")
@Transactional
public class BaseBuildingAreaServiceImpl extends CommonServiceImpl implements BaseBuildingAreaServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaseBuildingAreaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaseBuildingAreaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaseBuildingAreaEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaseBuildingAreaEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("no", t.getNo());
		map.put("name", t.getName());
		map.put("description", t.getDescription());
		map.put("manager", t.getManager());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaseBuildingAreaEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("base_building_area",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
