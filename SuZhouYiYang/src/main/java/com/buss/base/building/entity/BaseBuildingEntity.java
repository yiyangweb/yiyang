 ...
 */
@Entity
@Table(name = "base_building", schema = "")
@SuppressWarnings("serial")
public class BaseBuildingEntity implements java.io.Serializable {
	/**id*/
	private java.lang.String id;
	/**建筑物编号*/
    @Excel(name="建筑物编号",width=15)
	...
	@Column(name ="MANAGER",nullable=true,length=36)
