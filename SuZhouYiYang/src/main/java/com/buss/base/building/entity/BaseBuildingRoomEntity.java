 ...
 * @date 2018-07-08 08:59:56
 * @version V1.0   
 *
 */
@Entity
@Table(name = "base_building_room", schema = "")
@SuppressWarnings("serial")
public class BaseBuildingRoomEntity implements java.io.Serializable {
	/**建筑名称*/
    @Excel(name="建筑名称",width=15,dictTable ="base_building",dicCode ="id",dicText ="name")
	private java.lang.String baseBuildingId;
	/**楼层名称*/
    @Excel(name="楼层名称",width=15,dictTable ="base_building_storey",dicCode ="id",dicText ="name")
	private java.lang.String baseBuildingStoreyId;
	/**房间类型*/
    @Excel(name="房间类型",width=15,dictTable ="base_building_room_type",dicCode ="id",dicText ="name")
	...
	/**房间状态*/
    @Excel(name="房间状态",width=15,dicCode="rom_status")
	private java.lang.String status;
	/**房间信息描述*/
    @Excel(name="房间信息描述",width=15)
	...
	/**所属区域*/
    @Excel(name="所属区域",width=15,dictTable ="base_building_area",dicCode ="id",dicText ="name")
	...
	@Column(name ="BASE_BUILDING_STOREY_ID",nullable=true,length=36)
	...
	@Column(name ="BASE_BUILDING_ROOM_TYPE_ID",nullable=true,length=36)
	...
	@Column(name ="CREATE_DATE",nullable=true,length=4)
	...
	@Column(name ="UPDATE_DATE",nullable=true,length=4)
	...
	@Column(name ="BASE_BUILDING_AREA_ID",nullable=true,length=36)
