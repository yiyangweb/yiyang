 ...
 * @date 2018-07-15 21:32:23
 * @version V1.0   
 *
 */
@Entity
@Table(name = "money_leave_nurse", schema = "")
@SuppressWarnings("serial")
public class MoneyLeaveNurseEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  产生时间
	 */
	
	@Column(name ="ADD_DATE",nullable=true,length=32)
