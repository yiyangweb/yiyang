...
package com.buss.nh.leave.page;
 ...
 *
 */
public class CustomerLeaveNursePage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-相关费用*/
    @ExcelCollection(name="相关费用")
	private List<MoneyLeaveNurseEntity> moneyLeaveNurseList = new ArrayList<MoneyLeaveNurseEntity>();
		public List<MoneyLeaveNurseEntity> getMoneyLeaveNurseList() {
		return moneyLeaveNurseList;
		}
		public void setMoneyLeaveNurseList(List<MoneyLeaveNurseEntity> moneyLeaveNurseList) {
		this.moneyLeaveNurseList = moneyLeaveNurseList;
		}
	/**保存-检查情况*/
    @ExcelCollection(name="检查情况")
	private List<CheckLeaveNurseEntity> checkLeaveNurseList = new ArrayList<CheckLeaveNurseEntity>();
		public List<CheckLeaveNurseEntity> getCheckLeaveNurseList() {
		return checkLeaveNurseList;
		}
		public void setCheckLeaveNurseList(List<CheckLeaveNurseEntity> checkLeaveNurseList) {
		this.checkLeaveNurseList = checkLeaveNurseList;
		}
}
