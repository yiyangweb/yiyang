...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerToHotelController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"   onclick="popupClick(this,'id,no,name','customerId,customerNo,customerName','customer_base_pop')"  value='${customerToHotelPage.customerName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="customerNo" name="customerNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToHotelPage.customerNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input type="text" id="buildingId" style="width:155px;" value="${customerToHotelPage.buildingId}"/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input type="text" id="roomId" style="width:155px;" value="${customerToHotelPage.roomId}"/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="inCharge" name="inCharge" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToHotelPage.inCharge}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="inDate" name="inDate" type="text" style="width: 150px"   ignore="ignore" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${customerToHotelPage.inDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="outCharge" name="outCharge" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToHotelPage.outCharge}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="outDate" name="outDate" type="text" style="width: 150px"   ignore="ignore" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${customerToHotelPage.outDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="remarks" name="remarks" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToHotelPage.remarks}'/>
				<span class="Validform_checktip"></span>
