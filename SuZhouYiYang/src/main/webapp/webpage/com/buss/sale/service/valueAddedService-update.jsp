...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="valueAddedServiceController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<c:if test="${type == '1'}">
					<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"  onclick="popupClick(this,'customerId,customerName,customerRoomId,customerRoomName','customerId,customerName,roomId,roomName','customer_room_info')" value='${valueAddedServicePage.customerName}'/>
				</c:if>
				<c:if test="${type == '2'}">
					<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"  onclick="popupClick(this,'customer_id,customer_name,room_id,room_name,bed_id,bed_name','customerId,customerName,customerRoomId,customerRoomName,customerBedId,customerBedName','customer_bed_info')" value='${valueAddedServicePage.customerName}'/>
				</c:if>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="customerRoomName" name="customerRoomName" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="checked"  value='${valueAddedServicePage.customerRoomName}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="customerBedName" name="customerBedName" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="checked" value='${valueAddedServicePage.customerBedName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="serviceDetail" name="serviceDetail" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${valueAddedServicePage.serviceDetail}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${valueAddedServicePage.remark}'/>
				<span class="Validform_checktip"></span>
