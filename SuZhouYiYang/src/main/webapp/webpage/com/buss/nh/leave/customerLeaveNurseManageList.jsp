...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="customerLeaveNurseList" checkbox="true" fitColumns="true" title="退住申请" actionUrl="customerLeaveNurseController.do?datagrid2" idField="id" fit="true" queryMode="group">
