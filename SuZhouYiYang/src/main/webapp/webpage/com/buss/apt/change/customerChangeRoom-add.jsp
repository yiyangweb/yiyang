...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerChangeRoomController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="customerName" name="customerName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"  onclick="popupClick(this,'id,customer_no,customer_name,room_id,room_name,building_id,building_name','originId,customerNo,customerName,originRoomId,originRoom,originBuildingId,originBuildingName','stayin_info')"/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="originRoom" name="originRoom" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="originBuildingName" name="originBuildingName" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="newRoomName" name="newRoomName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"  onclick="popupClick(this,'room_id,room_name,building_id,building_name','newRoomId,newRoomName,newBuildingId,newBuildingName','empty_room_info')"/>			 
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="newBuildingName" name="newBuildingName" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
