...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="feeBillList" checkbox="true" fitColumns="true" title="收费单" actionUrl="${dataurl}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="缴费" icon="icon-le-ok"  url="feeBillController.do?goUpdate" funname="doCash"  width="100%" height="100%"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
 ...
 <script type="text/javascript">
 	//自定义按钮-sql增强-提交
 	function doCash(title,url, id,width,height,isRestful) {
        gridname=id;
        ...
        if("3"!=rowsData[0]['fbStatus'].toString()){
            tip('只有收费中状态的信息才可以修改！');
            return;
        }
