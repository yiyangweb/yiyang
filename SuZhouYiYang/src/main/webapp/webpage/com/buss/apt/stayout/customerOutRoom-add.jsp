...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerOutRoomController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="no" name="no" type="text" style="width: 150px" class="inputxt" readonly="true" validType="customer_out_room,no,id" datatype="*" ignore="checked" value='${customerOutRoomPage.no}'/>
			...
			<td class="value">
				<input id="roomName" name="roomName" type="text" style="width: 150px" class="searchbox-inputtext" readonly="true"  ignore="ignore"  onclick="popupClick(this,'room_name,customer_name,customer_no,id,room_id','roomName,customerName,customerNo,stayinId,roomId','stayin_info')"/>
