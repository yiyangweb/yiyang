...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerToRoomController.do?doUpdate" >
				  ...
				  <input id="crStatus" name="crStatus" type="hidden" value="${customerToRoomPage.crStatus }"/>
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="customerName" name="customerName" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="checked"  value='${customerToRoomPage.customerName}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="customerNo" name="customerNo" type="text" style="width: 150px" class="inputxt" 		datatype="*" ignore="checked"  value='${customerToRoomPage.customerNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="buildingName" name="buildingName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToRoomPage.buildingName}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="roomName" name="roomName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToRoomPage.roomName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="trainStatus" type="list"   typeGroupCode="px_status"  defaultVal="${customerToRoomPage.trainStatus}" hasLabel="false"  title="培训状态"></t:dictSelect>     
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="inCharge" name="inCharge" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToRoomPage.inCharge}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="inDate" name="inDate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${customerToRoomPage.inDate}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerToRoomPage.remark}'/>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_customerTrainInfo_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td align="left">
					      	<input name="customerTrainInfoList[#index#].beginDate" maxlength="32"  ignore="ignore"  type="text"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:120px;" />
					  <label class="Validform_label" style="display: none;">开始时间</label>
				  </td>
				  <td align="left">
					      	<input name="customerTrainInfoList[#index#].endDate" maxlength="32"  ignore="ignore"  type="text"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:120px;" />
		...
		<tbody id="add_customerRoomDes_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  				<input name="customerRoomDesList[#index#].customerName" name="customerRoomDesList[#index#].customerName" type="text" style="width: 150px" class="searchbox-inputtext" 		datatype="*" ignore="checked"    onclick="popupClick(this,'id,name','customerId,customerName','customer_base')" value="${poVal.customerName }" />
				  ...
				  <td align="left">
					      	<input name="customerRoomDesList[#index#].beginDate" maxlength="32"  ignore="ignore"  type="text"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:120px;" />
					  <label class="Validform_label" style="display: none;">入住时间</label>
				  </td>
				  <td align="left">
