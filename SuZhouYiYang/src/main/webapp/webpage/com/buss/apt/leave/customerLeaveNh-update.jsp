...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerLeaveNhController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<input id="roomName" name="roomName" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"   onclick="popupClick(this,'stayinId,roomId,roomName,customerName,customerNo','stayin_info')"  value='${customerLeaveNhPage.roomName}'/>			    
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="customerName" name="customerName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerLeaveNhPage.customerName}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="customerNo" name="customerNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerLeaveNhPage.customerNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="inCharge" name="inCharge" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerLeaveNhPage.inCharge}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="dealDate" name="dealDate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${customerLeaveNhPage.dealDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="auditor" name="auditor" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerLeaveNhPage.auditor}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="auditDate" name="auditDate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${customerLeaveNhPage.auditDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="auditDes" name="auditDes" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customerLeaveNhPage.auditDes}'/>
				<span class="Validform_checktip"></span>
