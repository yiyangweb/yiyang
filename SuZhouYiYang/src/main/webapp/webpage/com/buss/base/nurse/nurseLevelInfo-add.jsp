...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nurseLevelInfoController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:300px;height:100px;" class="inputxt" rows="8" id="description" name="description"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="width:300px;height:100px;" class="inputxt" rows="8" id="chargeStandard" name="chargeStandard"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
