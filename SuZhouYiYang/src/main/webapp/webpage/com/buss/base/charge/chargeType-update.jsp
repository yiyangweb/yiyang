...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="chargeTypeController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${chargeTypePage.name}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="description" name="description" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${chargeTypePage.description}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<input id="belongDeptCode" name="belongDeptCode" type="hidden" readonly="readonly" class="inputxt" datatype="*" value="${chargeTypePage.belongDeptCode}"/>
							<input id="belongDeptName" name="belongDeptName" type="text" value="${chargeTypePage.belongDeptName}"/>
					...
					<tr>
						...
						<td class="value">
						    <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${chargeTypePage.remark}'/>
							<span class="Validform_checktip"></span>
